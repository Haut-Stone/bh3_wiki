    ...
    function jSnow(){
        ...
        var defaults = {
            ...
            flake = function(_el, _size, _speed)
            {
                ...
                setStyle(flakeObj, {'width' : this.size, 'height' : this.size, 'position' : defaults.flakePosition, 'top' : 0, 'left' : 0, 'will-change': 'transform', 'fontSize' : 0, 'zIndex' : defaults.flakeIndex}, 'rotate');
                ...
                this.update = function(){
                    ...
                    transform(this.element, 'translateY('+this.y+'px) translateX('+this.x+'px) rotate('+this.rotate+'deg)');
